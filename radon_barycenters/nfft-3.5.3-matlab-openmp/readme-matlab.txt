This archive contains the Matlab interface of NFFT 3.5.3
compiled for 64-bit Windows using GCC 11.2.0 x86_64-w64-mingw32
with -march=haswell and Matlab R2020b Update 3,
x86_64 Linux using GCC 11.2.0 with -march=haswell
and Matlab R2021b,
x86_64 macOS using GCC 11 with -march=haswell
and Matlab R2021b Update 1.
In addition, the binaries for Octave 7.1.0 on Windows are included.
